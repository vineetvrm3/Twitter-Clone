...
//API - 3 : Get user tweets and feeds
...
//API 6 Get tweets of a specific Id
...
//API 8 Get replies on a tweet with specific id
app.get(
...
//API 9 Get all the tweets from a specific user
